export default function Button(){
    return (
        ...
        <div className="h-15 w-40 bg-violet-500 px-9 flex items-center border-none rounded-2xl mt-4 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-lg">
            Start Now
        </div>
